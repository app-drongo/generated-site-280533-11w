// Enhanced by AI on 2025-08-17T11:47:43.956Z
// Section: cta
// Category: cta
...
export default function CTA() {
  const stats = [
    ...
    { value: "500+", label: "SAP Integrations", icon: Zap },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                Unlock the Power of SAP for Your
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join the thousands of businesses who have transformed their operations with our expert SAP consulting services. Start your journey today with a free trial.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by leading manufacturing and logistics companies
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Get started quickly with our expert-led onboarding
              </p>
            </div>
          </div>
        </div>
