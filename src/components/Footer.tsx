// Enhanced by AI on 2025-08-17T11:47:43.050Z
// Section: footer
// Category: footer
...
export default function Footer() {
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: "Manufacturing Solutions", href: "#manufacturing" },
        { name: "Warehouse Management", href: "#warehouse" },
  ...
  const socialLinks = [
    ...
    { name: "LinkedIn", icon: Linkedin, href: "https://linkedin.com/company/acmesapconsulting" },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Unlocking the Power of SAP for Manufacturing and Logistics. Trusted by leading enterprises to drive digital transformation and optimize operations.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">123 Enterprise Way, Suite 100</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest updates on our SAP consulting services and industry insights. Unsubscribe anytime.
              </p>
            </div>
          </div>
